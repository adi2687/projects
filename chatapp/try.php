...
<body>
    <div class="status-container">
        ...
        try {
            ...
            $query = "SELECT DISTINCT users.unique_id, users.img, status.statusmessage FROM users INNER JOIN status ON users.unique_id = status.unique_id WHERE users.unique_id != :id ORDER BY status.id DESC";
