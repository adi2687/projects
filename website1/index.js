...
function pop(infoClass) {
    // Get all info boxes and hide them
    ...
    let selectedBox = document.getElementsByClassName(infoClass)[0];
...
document.getElementById("closebutton").addEventListener("click",function(){
    ...
    let a=document.getElementsByClassName("infobox");
