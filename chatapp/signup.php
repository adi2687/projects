...
$query = "INSERT INTO users (unique_id, fname, lname, email, password, img, status, lastse) VALUES (:randomid, :fname, :lname, :email, :hashedPassword, :newimgname, :status, :lastse)";
$stmt = $pdo->prepare($query);
